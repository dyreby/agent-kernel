...
- **Addressing feedback**: Check *both* PR-level comments (`gh pr view --comments`) *and* inline review comments (`gh api repos/{owner}/{repo}/pulls/{n}/comments`). Reply to each, summarizing what changed and why.
